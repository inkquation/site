...
export const guideLocales = ['ja', 'en'];
export const guideRoute = (locale) => (locale === 'ja' ? '/ai/' : '/en/ai/');
...
export function guideMarkdown(locale, origin, basePath) {
  ...
  lines.push(
    '',
    `[${guide.homeLabel}](${linkURL(locale === 'ja' ? '/' : '/en/', origin, basePath)})`,
  );
  return `${lines.join('\n')}\n`;
}
...
- [AI integration guide — English, Markdown](${url('/en/ai/index.md')}): Setup, all seven tools, coordinates, limits, JSON examples, retries and Undo. Content checked on ${guides.updated}.
- [AI integration guide — Japanese, Markdown](${url('/ai/index.md')}): The same guide in Japanese.
- [AI integration guide — English, HTML](${url('/en/ai/')}): Readable guide with section navigation.
- [AI integration guide — Japanese, HTML](${url('/ai/')}): Readable Japanese guide.
